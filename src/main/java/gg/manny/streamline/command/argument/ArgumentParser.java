package gg.manny.streamline.command.argument;

import com.google.common.base.Preconditions;
import gg.manny.streamline.command.annotation.Flag;
import gg.manny.streamline.command.command.CommandExecution;
import gg.manny.streamline.command.command.CommandFlag;
import gg.manny.streamline.command.command.DrinkCommand;
import gg.manny.streamline.command.command.DrinkCommandService;
import gg.manny.streamline.command.exception.CommandArgumentException;
                ...
                if (!args.hasNext()) {
                    if (provider.doesConsumeArgument()) {
                        if (param.isOptional()) {
                            ...
                            throw new CommandArgumentException("Missing argument for: " + ChatColor.YELLOW + param.getParameter().getName());
                        }
                    }
                }
