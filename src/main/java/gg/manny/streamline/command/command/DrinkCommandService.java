...
import gg.manny.streamline.command.annotation.Duration;
import gg.manny.streamline.command.annotation.Sender;
import gg.manny.streamline.command.annotation.Text;
import gg.manny.streamline.command.argument.ArgumentParser;
import gg.manny.streamline.command.argument.CommandArgs;
import gg.manny.streamline.command.exception.*;
import gg.manny.streamline.command.modifier.DrinkModifier;
import gg.manny.streamline.command.modifier.ModifierService;
import gg.manny.streamline.command.parametric.BindingContainer;
import gg.manny.streamline.command.parametric.DrinkBinding;
import gg.manny.streamline.command.parametric.DrinkProvider;
import gg.manny.streamline.command.parametric.ProviderAssigner;
import gg.manny.streamline.command.parametric.binder.DrinkBinder;
import gg.manny.streamline.command.provider.*;
import gg.manny.streamline.command.provider.spigot.*;
...
public class DrinkCommandService implements CommandService {
    ...
    private void bindDefaults() {
        ...
        bind(Skin.class).toProvider(new SkinProvider(plugin));
    }
