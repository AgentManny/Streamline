...
public class DrinkCommandContainer extends Command implements PluginIdentifiableCommand {
    ...
    private boolean defaultCommandIsHelp = true;
    ...
    public final gg.manny.streamline.command.command.DrinkCommandContainer registerSub(@Nonnull Object handler) {
    ...
    public gg.manny.streamline.command.command.DrinkCommandContainer setOverrideExistingCommands(boolean overrideExistingCommands) {
    ...
    public gg.manny.streamline.command.command.DrinkCommandContainer setDefaultCommandIsHelp(boolean defaultCommandIsHelp) {
