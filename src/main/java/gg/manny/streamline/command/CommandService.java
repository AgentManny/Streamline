package gg.manny.streamline.command;

import gg.manny.streamline.command.command.DrinkAuthorizer;
import gg.manny.streamline.command.command.DrinkCommandContainer;
import gg.manny.streamline.command.modifier.DrinkModifier;
import gg.manny.streamline.command.parametric.binder.DrinkBinder;
 ...
 * <p>
 * See {@link Drink#get(JavaPlugin)} for getting an instance of a functional {@link gg.manny.streamline.command.CommandService}
 */
public interface CommandService {

    /**
     * Register a Drink command into the Drink Command Service
     * @param handler Object that has the {@link gg.manny.streamline.command.annotation.Command} annotated methods
     ...
     * {@link gg.manny.streamline.command.annotation.Command} annotation set name = ""
     ...
     * @param handler The object that has the {@link gg.manny.streamline.command.annotation.Command}
    ...
    /**
     * Start binding a class type to a {@link gg.manny.streamline.command.parametric.DrinkProvider} or instance.
     ...
     * @param annotation The annotation to use for the modifier (must have {@link gg.manny.streamline.command.annotation.Modifier} annotated in it's class)
