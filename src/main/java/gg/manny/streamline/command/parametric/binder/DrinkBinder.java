package gg.manny.streamline.command.parametric.binder;
...
import gg.manny.streamline.command.provider.InstanceProvider;
...
public class DrinkBinder<T> {
    ...
    public gg.manny.streamline.command.parametric.binder.DrinkBinder<T> annotatedWith(@Nonnull Class<? extends Annotation> annotation) {
