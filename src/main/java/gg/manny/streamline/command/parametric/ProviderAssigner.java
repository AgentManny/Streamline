package gg.manny.streamline.command.parametric;

import gg.manny.streamline.command.command.DrinkCommand;
import gg.manny.streamline.command.command.DrinkCommandService;
import gg.manny.streamline.command.exception.CommandStructureException;
import gg.manny.streamline.command.exception.MissingProviderException;
